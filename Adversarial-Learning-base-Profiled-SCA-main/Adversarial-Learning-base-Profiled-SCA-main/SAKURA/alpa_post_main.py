...
if __name__ == '__main__':
  ...
  # Y_profiling是十进制，需要转换为二进制，并计算汉明重量
    ...
    model = ATN(num_classes=256)
    discriminator = Discriminator()
    pretrained_path = './models/IDfake_pre-trained_cpda_device1.pth'
    ...
    for epoch in range(1, finetune_epoch + 1):
        ...
        if (val_total_loss < min_loss):
            ...
            }, './models/ID' +str(adjust_flag)+"_in_features_"+str(in_features)+"finetune_epoch"+str(finetune_epoch) + 'best_valid_loss_fine_tuned_alpa_device{}_to_{}.pth'.format(
