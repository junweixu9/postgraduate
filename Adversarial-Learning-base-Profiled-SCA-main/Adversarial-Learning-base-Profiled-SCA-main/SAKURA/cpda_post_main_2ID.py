...
if __name__ == '__main__':
    ...
    labeling_method = 'id'  # labeling of trace
    ...
    checkpoint = torch.load(
        './models/ID'+str(flag)+str(target_finetune_num)+'best_valid_loss_fine_tuned_cpda_device{}_to_{}.pth'.format(source_device_id, target_device_id))
