...
if __name__ == '__main__':
    ...
    path = './models/hw' + str(flag) + '_pre-trained_cpda_device{}.pth'.format(source_device_id)
    ...
    for epoch in range(1, finetune_epoch + 1):
        ...
        with torch.no_grad():
            ...
            if valid_loss < min_loss:
                ...
                save_path = './models/LMMDHW' + str(flag) + '_best_valid_loss_fine_tuned_cpda_device{}_to_{}.pth'.format(
