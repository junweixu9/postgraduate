...
if __name__ == '__main__':
    ...
    if adjust_flag:
        ...
        flag = "fake"
    path = './models/alpa_'+str(adjust_flag)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id)
    # path = './models/best_valid_loss_finetuned_device1_to_2.pth'
