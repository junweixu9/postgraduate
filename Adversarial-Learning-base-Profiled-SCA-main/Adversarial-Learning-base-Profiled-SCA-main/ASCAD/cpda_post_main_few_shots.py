...
if __name__ == '__main__':
    ...
    if adjust_flag == True:
        ...
        flag = "real"
        pretrained_path = './models/_clockjitter_level1_real_pre-trained_cpda_device0.pth'
    else:
        flag = "fake"
        pretrained_path = './models/_clockjitter_level1_fake_pre-trained_cpda_device0.pth'
