...
def cmmd_loss(source, target, s_label, t_label, num_classes=256, kernel_mul=2.0, kernel_num=5, fix_sigma=None):
    """
...
if __name__ == '__main__':
    ...
    pretrained_path = f'./models/ID{countermeasure}_{flag}_pre-trained_cpda_device{source_device_id}.pth'
    ...
    for epoch in range(1, finetune_epoch + 1):
        ...
        if valid_loss < min_loss:
            ...
            save_path = f'./models/ID{countermeasure}_{flag}_best_valid_loss_fine_tuned_cpda_device{source_device_id}_to_{target_device_id}.pth'
            torch.save({
                'epoch': epoch,
