...
if __name__ == '__main__':
    ...
    ckpt_path = './models/alpa_id_'+str(adjust_flag)+str(countermeasure)+str(target_finetune_num)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id)
    checkpoint = torch.load(ckpt_path, map_location='cuda' if cuda else 'cpu')
