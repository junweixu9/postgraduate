...
def plot_guessing_entropy(preds, real_key, device_id, model_flag):
    ...
    plt.subplot(1, 2, 1)
    p1, = plt.plot(avg_ge, color='red')
    plt.xlabel('Number of trace')
    plt.ylabel('Guessing entropy')

    plt.subplot(1, 2, 2)
    p2, = plt.plot(avg_sr, color='red')
    plt.xlabel('Number of trace')
...
if __name__ == '__main__':
    ...
    if adjust_flag == True:
        ...
        flag = "real"
        path = './models/hw_clockjitter_level1_real_pre-trained_cpda_device0.pth'
    else:
        flag = "fake"
        path = './models/hw_clockjitter_level1_fake_pre-trained_cpda_device0.pth'
