...
if __name__ == '__main__':
    source_device_id = 0
    target_device_id = 1
    real_key_01 = 46  # key of the source domain
    real_key_02 = 23  # key of the target domain
    ...
    # model & optimizer
    # -----------------
    CDP_model = ATN(num_classes=class_num).to(device)
    ...
    for epoch in range(1, finetune_epoch + 1):
        ...
        ALPA_train(epoch, CDP_model, discriminator)

        val_total_loss, val_tgt_loss, val_cls_loss = ALPA_validation(CDP_model, discriminator)
        ...
        if (val_total_loss < min_loss):
            ...
            if not os.path.exists('models'):
                ...
                }, './models/hw'+str(flag)+'_best_valid_loss_finetuned_device{}_to_{}.pth'.format(source_device_id, target_device_id))
