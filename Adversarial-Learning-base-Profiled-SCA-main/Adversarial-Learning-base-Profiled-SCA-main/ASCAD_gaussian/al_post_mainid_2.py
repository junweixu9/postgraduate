...
if __name__ == '__main__':
    ...
    trace_offset = 0
    trace_length = 700
    countermeasure = '_GaussianNoise_level8'
    noise_level = 8
    ...
    checkpoint = torch.load(
        './models/alpa_id_'+str(adjust_flag)+str(countermeasure)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id))
    finetuned_dict = checkpoint['model_state_dict']
    print('./models/alpa_id_'+str(adjust_flag)+str(countermeasure)+str(target_finetune_num)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id))
