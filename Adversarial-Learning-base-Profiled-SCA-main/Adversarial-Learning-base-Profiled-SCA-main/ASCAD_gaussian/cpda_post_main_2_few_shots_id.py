...
if __name__ == '__main__':
    ...
    checkpoint = torch.load(
        './models/'+str(13)+str(countermeasure)+'_'+str(flag)+str(target_finetune_num)+'_best_valid_loss_fine_tuned_cpda_device{}_to_{}.pth'.format(source_device_id, target_device_id))
    finetuned_dict = checkpoint['model_state_dict']
    print('./models/'+str(13)+str(countermeasure)+'_'+str(flag)+str(target_finetune_num)+'_best_valid_loss_fine_tuned_cpda_device{}_to_{}.pth'.format(source_device_id, target_device_id))
