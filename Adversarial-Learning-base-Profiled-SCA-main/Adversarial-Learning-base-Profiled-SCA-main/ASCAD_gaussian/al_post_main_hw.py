...
if __name__ == '__main__':
    ...
    if adjust_flag == True:
        ...
        flag = "real"
        pretrained_path = './models/hw_GaussianNoise_level4_real_pre-trained_cpda_device0.pth'
    else:
        flag = "fake"
        pretrained_path = "./models/hw_GaussianNoise_level4_fake_pre-trained_cpda_device0.pth"
    ...
    for epoch in range(1, finetune_epoch + 1):
        ...
        if (val_total_loss < min_loss):
            ...
            }, './models/alpa_hw_'+str(flag)+str(countermeasure)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id))
