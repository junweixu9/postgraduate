...
if __name__ == '__main__':
    ...
    print('./models/lmmdhw'+str(countermeasure)+'_'+str(flag)+str(target_finetune_num)+'_best_valid_loss_fine_tuned_cpda_device{}_to_{}.pth'.format(source_device_id, target_device_id))
