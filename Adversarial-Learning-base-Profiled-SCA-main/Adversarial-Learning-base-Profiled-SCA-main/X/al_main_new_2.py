...
if __name__ == '__main__':
    ...
    if os.path.exists('./models/alpa'+str(adjust_flag)+str(target_finetune_num)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id)):
        # checkpoint = torch.load('./models/'+str(adjust_flag)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id))
        checkpoint = torch.load('./models/alpa'+str(adjust_flag)+str(target_finetune_num)+'final_device{}_to_{}.pth'.format(source_device_id, target_device_id))
