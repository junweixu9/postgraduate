...
if __name__ == '__main__':
    ...
    # logit adjustment
    adjustments_np = compute_adjustment_1(Y_train_source[0:train_num], tro=0.1, classes=9)
    ...
    adjust_flag = True  # 训练阶段是否启用
    tro = 1.5
    if adjust_flag:
        flag = "real"
    else:
        flag = "fake"
    path = './models/'+str(flag)+str(tro)+'_pre-trained_cpda_device{}.pth'.format(source_device_id)
    ...
    for epoch in range(1, finetune_epoch + 1):
        ...
        with torch.no_grad():
            ...
            if valid_loss < min_loss:
                ...
                }, './models/hw'+str(target_finetune_num)+str(flag)+str(tro)+'_best_valid_loss_finetuned_device{}_to_{}.pth'.format(source_device_id,
                                                                                     target_device_id))
