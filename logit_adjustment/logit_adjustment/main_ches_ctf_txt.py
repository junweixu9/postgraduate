...
if __name__ == '__main__':
    ...
    kl_loss_logs = []
    count = 0
    log = open('C:/Users/Administrator/OneDrive/Desktop/result/ches_ldl_logit_7000.txt', mode='a',
               encoding='utf-8')
    best_weights = None
    tro = 0.25
    adjust_flag = True
    ...
    if sigma_hw == 0 and sigma_id == 0:
        ...
        #     print("GE:", attack_traces[-1, correct_key], file=log)
        #     for epoch in range(len(loss)):
        #         print("轮数", epoch, "__train_loss_", loss[epoch], "__rank_", all_rank_logs[epoch],"___corr_", all_corr_logs[epoch], file=log)
        #     log.close()
        # else:
        #     print(file=log)
        #     print(experiment_time, file=log)
        ...
        #     print("TGE0:", np.argmax(attack_traces[:, correct_key] < 1), file=log)
        #     for epoch in range(len(loss)):
        #         print("轮数", epoch, "___train_loss_", loss[epoch], "___rank_", all_rank_logs[epoch],"___corr_", all_corr_logs[epoch], file=log)
        #     log.close()
