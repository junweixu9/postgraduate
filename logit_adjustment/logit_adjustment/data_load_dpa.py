...
def read_data(leakage_model, data_arguementation, data_arguementation_level,
    ...
    index_ascending_container_representation = ss.rankdata(label_puv_container_representation, method='dense', axis=1)
    ...
    return (X_profiling, X_attack), (Y_profiling_Q, Y_attack), (
        plt_profiling,
        plt_attack), correct_key, attack_byte, num_profiling_traces,index_ascending_container_representation
