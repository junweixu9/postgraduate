...
from tensorflow.keras.layers import Conv1D, Conv2D, AveragePooling2D, MaxPooling1D, MaxPooling2D, BatchNormalization, \
    AveragePooling1D
...
class NeuralNetwork:
    ...
    def cnn_random(self, classes, number_of_samples, activation, neurons, conv_layers, filters, kernel_size, stride,
