...
def perform_attacks(all_valid_plt_attack, y_pred, output_metric, leakage_model, dataset, nb_traces_attacks,
    ...
    inv = [1.0, 0.125, 0.03571428571428571, 0.017857142857142854,
...
def compute_values(predicted_output, result):
    return predicted_output / result[predicted_output]
...
def rank_compute(yibufen_attack_pred, yibufen_attack_plt, attack_byte, k_c, output_metric, leakage_model,
    ...
    result = [1.0, 0.125, 0.03571428571428571, 0.017857142857142854,
              0.014285714285714285, 0.017857142857142854, 0.03571428571428571,
              0.125, 1.0]
    ...
    for i in range(nb_traces):
        ...
        predicted_output_adjust = compute_values(predicted_output, result)
        #  并进行对应密钥得分的相乘
