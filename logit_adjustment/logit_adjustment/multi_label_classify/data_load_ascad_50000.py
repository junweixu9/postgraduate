...
def read_data(leakage_model, data_arguementation, data_arguementation_level,
    ...
    if dataset == 'ASCAD':
        ...
        data_root = ('C:/workspace/code/logit_adjustment/logit_adjustment/ASCAD_data/ASCAD_databases/ascad-variable.h5')
        correct_key = 34
        attack_byte = 2
