...
def adjustment_loss(y_true, y_pred):
    ...
    p_1_p = tf.reduce_sum(tf.multiply(y_pred, 1 - y_pred), 1)
    loss = tk.backend.categorical_crossentropy(y_true, y_pred)+p_1_p
    return loss
...
if __name__ == '__main__':
    ...
    log = open('F:/result/all/a/ce_1000_ldl_logit.txt', mode='a',
               encoding='utf-8')
    print(file=log)
    print(file=log)
    """创建神经网络模型"""
    ...
    """最佳模型的存储地址"""
    test_info = ('dataset{}_leakage_model{}_epoch{}_batch_size{}_adjust_flag{}_sigma_hw{}_nump{}'
    ...
    model_root = 'C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/all/model_save/'
