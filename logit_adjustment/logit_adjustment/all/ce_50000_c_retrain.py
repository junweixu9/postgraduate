...
if __name__ == '__main__':
    ...
    #                                                                                   )
    #
    # model_root = 'E:/logit_backup/ensemble_model/datasetCHES_CTF_leakage_modelHW_epoch50_batch_size128_outputallfalsetime_is3_19_39.h5'
    ...
    attack_traces = perform_attacks(plt_attack[:5000], predictions, "attack_traces",
                                    leakage_model, dataset, num_traces_attacks)
    log = open('F:/result/cnn/c/logit_curve_3000_none_tro1.txt', mode='a',
               encoding='utf-8')
