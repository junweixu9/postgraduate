...
def brier_compute(leakage_model,
    ...
    if dataset == "ASCAD":
        ...
        model.load_weights(
            r'./model_save/datasetASCAD_leakage_modelHW_epoch15_batch_size32_adjust_flagFalse_sigma_hw1_nump50000.h5')
        ...
        model.load_weights(
            r'./model_save/datasetASCAD_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_sigma_hw1_nump50000.h5')
        ...
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagFalse_sigma_hw2_nump50000.h5')
        y_pred_ce = model.predict(X_attack[:5000])
        ...
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_sigma_hw2_nump50000.h5')
        y_pred_ce_logit = model.predict(X_attack[:5000])
    else:
        (X_profiling, X_attack), (Y_profiling, Y_attack), (
            plt_profiling, plt_attack), correct_key, attack_byte, num_profiling_traces = read_data(
        ...
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagFalse_sigma_hw2_nump45000.h5')
        y_pred_ce = model.predict(X_attack[:5000])
        ...
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_sigma_hw2_nump45000.h5')
        y_pred_ce_logit = model.predict(X_attack[:5000])
...
if __name__ == '__main__':
    ...
    print("a_brier_score_ce_ldl:", a_brier_score_ce)
    print("a_brier_score_ce_logit_ldl:", a_brier_score_ce_logit)
    print("ar_brier_score_ce_ldl:", ar_brier_score_ce)
    print("ar_brier_score_ce_logit_ldl:", ar_brier_score_ce_logit)
    print("c_brier_score_ce_ldl:", c_brier_score_ce)
    print("c_brier_score_ce_logit_ldl:", c_brier_score_ce_logit)
