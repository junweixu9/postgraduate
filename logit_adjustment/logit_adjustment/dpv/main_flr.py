...
def cnn_architecture(input_size=700, learning_rate=0.00001, classes=9):
    ...
    model.compile(loss=flr_adjustment_loss, optimizer='adam', metrics=None)
    model.summary()
    return model
...
def train_model(X_profiling, Y_profiling, X_test, Y_test, model, epochs=150, batch_size=100,
    ...
    callbacks = [lr_manager, all(validation=(Reshaped_X_test, plt_attack[:5000], Y_test))]
...
if __name__ == '__main__':
    ...
    input_size = 3500
    learning_rate = 5e-3
    num_traces_attacks = 80
    nb_attacks = 20
    real_key = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/key.npy")
    correct_key = real_key[0]
    leakage_model = 'HW'

    # Load the profiling traces
    X_profiling = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/profiling_traces_AES_RD.npy")
    Y_profiling = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/profiling_labels_AES_RD.npy")
    X_attack = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/attack_traces_AES_RD.npy")
    Y_attack = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/attack_labels_AES_RD.npy")
    plt_profiling = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/profiling_plaintext_AES_RD.npy")
    plt_attack = np.load("C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/aes_rd/attack_plaintext_AES_RD.npy")
    ...
    # Record the metrics
    history = train_model(X_profiling[:25000], Y_profiling[:25000], X_attack[:5000], Y_attack[:5000], model,
    ...
    log = open('F:/result/aes_rd/flr.txt', mode='a',
               encoding='utf-8')
