...
def brier_compute(leakage_model,
    ...
    if dataset == "ASCAD":
        ...
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagFalse_tao0_sigma_hw2_nump10000.h5')
        y_pred_ce = model.predict(X_attack[:5000])
        ...
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.1_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_01 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.2_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_02 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.265_sigma_hw2_nump10000.h5')
        y_pred_ce_logit = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.4_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_04 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.5_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_05 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.6_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_06 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.7_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_07 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.8_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_08 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao1_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_1 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetASCAD_rand_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao1.1_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_11 = model.predict(X_attack[:5000])
        ...
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagFalse_tao0_sigma_hw2_nump10000.h5')
        y_pred_ce = model.predict(X_attack[:5000])
        ...
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.1_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_01 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.2_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_02 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.275_sigma_hw2_nump10000.h5')
        y_pred_ce_logit = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.4_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_04 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.5_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_05 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.6_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_06 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.7_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_07 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao0.8_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_08 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao1_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_1 = model.predict(X_attack[:5000])
        model.load_weights(
            r'./model_save/datasetCHES_CTF_leakage_modelHW_epoch15_batch_size32_adjust_flagTrue_tao1.1_sigma_hw2_nump10000.h5')
        y_pred_ce_logit_11 = model.predict(X_attack[:5000])

    y_true = Y_attack[:5000, :9]

    brier_score_ce = ece_score(y_pred_ce, y_true, n_bins=5)
    brier_score_ce_logit = ece_score(y_pred_ce_logit, y_true, n_bins=5)
    brier_score_ce_logit_01 = ece_score(y_pred_ce_logit_01, y_true, n_bins=5)
    brier_score_ce_logit_02 = ece_score(y_pred_ce_logit_02, y_true, n_bins=5)
    brier_score_ce_logit_04 = ece_score(y_pred_ce_logit_04, y_true, n_bins=5)
    brier_score_ce_logit_05 = ece_score(y_pred_ce_logit_05, y_true, n_bins=5)
    brier_score_ce_logit_06 = ece_score(y_pred_ce_logit_06, y_true, n_bins=5)
    brier_score_ce_logit_07 = ece_score(y_pred_ce_logit_07, y_true, n_bins=5)
    brier_score_ce_logit_08 = ece_score(y_pred_ce_logit_08, y_true, n_bins=5)
    brier_score_ce_logit_1 = ece_score(y_pred_ce_logit_1, y_true, n_bins=5)
    brier_score_ce_logit_11 = ece_score(y_pred_ce_logit_11, y_true, n_bins=5)
