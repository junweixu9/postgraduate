...
#
#     log = open('F:/result/tao/a/50000/1hw0_none.txt', mode='a',
#                encoding='utf-8')
#     print(file=log)
#     print(file=log)
#     """创建神经网络模型"""
...
#     """最佳模型的存储地址"""
#     test_info = ('dataset{}_leakage_model{}_epoch{}_batch_size{}_adjust_flag{}_tao{}_sigma_hw{}_nump{}'
#                  ).format(dataset, leakage_model,
#                           epoch,
#                           batch_size,
#                           adjust_flag, tro,
#                           sigma_hw, X_profiling.shape[0],
#                           )
#     model_root = 'C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/tao/model_save/'
#
#     filename = model_root + test_info + '.h5'
#     """开始训练"""
#     history = model.fit(x=X_profiling, y=Y_profiling[:, :9], batch_size=batch_size, verbose=2, epochs=epoch,
#                         callbacks=callback)
#     # model.save(filename)
#     y_pred_valid_metric = model.predict(X_attack[:5000])
#     y_pred_valid_metric = tf.nn.softmax(y_pred_valid_metric)
#     y_pred_valid_metric_int = tf.argmax(y_pred_valid_metric, axis=-1)
#
...
#     cm =  np.array([
#     [0, 0, 0, 10, 6, 0, 0, 0, 0],
#     [0, 12, 5, 63, 71, 10, 0, 0, 0],
#     [0, 12, 10, 225, 269, 37, 0, 0, 0],
#     [0, 14, 7, 436, 502, 122, 0, 0, 1],
#     [0, 14, 7, 490, 727, 165, 0, 1, 0],
#     [0, 9, 9, 301, 585, 168, 0, 0, 0],
#     [0, 3, 5, 142, 306, 88, 0, 0, 0],
#     [0, 0, 0, 35, 81, 32, 0, 0, 0],
#     [0, 0, 0, 3, 10, 7, 0, 0, 0]
# ])
    ...
    # 自动调整布局
    plt.tight_layout()
    title = "C:/Users/Administrator/OneDrive/Desktop/许俊伟/2025_6_2_bilstm/" +"3.png"
