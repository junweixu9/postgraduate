...
def read_data(leakage_model, data_arguementation, data_arguementation_level,
    ...
    if dataset == 'ASCAD':
        ...
        (X_profiling, X_attack), (Y_profiling, Y_attack), (plt_profiling, plt_attack), (
            ...
            "C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/ASCAD_data/ASCAD_databases/ASCAD_desync50.h5",
            leakage_model=leakage_model,
            profiling_traces=num_profiling_traces,
            key_info=True)
    elif dataset == 'ASCAD_rand':
        data_root = ('C:/Users/Administrator/OneDrive/Desktop/许俊伟/logit_adjustment/ASCAD_data/ASCAD_databases/ascad-variable-desync50.h5'
                     '-variable.h5')
        correct_key = 34
        attack_byte = 2
        num_profiling_traces = 50000
