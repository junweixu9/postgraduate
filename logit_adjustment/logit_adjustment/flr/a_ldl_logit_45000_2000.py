from data_load_ascad_45000 import read_data
...
if __name__ == '__main__':
    ...
    log = open('F:/result/flr/a/45000_2000_ldl_logit.txt', mode='a',
               encoding='utf-8')
    print(file=log)
    print(file=log)
    """创建神经网络模型"""
    ...
    callback = [
        all(validation=(X_attack[:2000], plt_attack[:2000], Y_attack[:2000]))
    ]
