...
if __name__ == '__main__':
    ...
    lr_manager = OneCycleLR(len(X_profiling), 256, 1e-2, end_percentage=0.2, scale_percentage=0.1, maximum_momentum=None, minimum_momentum=None, verbose=True)
    ...
    log = open('F:/result/desyn/a/100_desync_10000_ldl_1tro075_new_60.txt', mode='a',
               encoding='utf-8')
    print(file=log)
    print(file=log)
