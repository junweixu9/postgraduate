...
from SCA_util_logit_adjustment import perform_attacks
import DL_model_100
import numpy as np
...
if __name__ == '__main__':
    ...
    lr_manager = OneCycleLR(len(X_profiling[45000:50000]), 256, 1e-2, end_percentage=0.2, scale_percentage=0.1, maximum_momentum=None, minimum_momentum=None, verbose=True)

    callback = [
        all(validation=(X_profiling[45000:50000], plt_profiling[45000:50000], Y_profiling[45000:50000])), lr_manager
    ]
    #
    ...
    log = open('F:/result/desyn/a/50000_ce_0tro0_knl_desync100.txt', mode='a',
               encoding='utf-8')
    print(file=log)
    print(file=log)
