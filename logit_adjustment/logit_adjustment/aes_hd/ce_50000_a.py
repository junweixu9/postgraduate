...
if __name__ == '__main__':
    ...
    """变量配置"""
    dataset = 'AES_HD'  # ASCAD/ASCAD_rand/CHES_CTF/AES_HD
    leakage_model = 'HW'
    ...
    lr_manager = OneCycleLR(len(X_profiling[40000:45000]), 256, learning_rate, end_percentage=0.2, scale_percentage=0.1,
                            maximum_momentum=None, minimum_momentum=None, verbose=True)

    callback = [
        lr_manager, all(validation=(X_profiling[40000:45000], plt_profiling[40000:45000], Y_profiling[40000:45000]))
    ...
    history = model.fit(x=X_profiling[:40000], y=Y_profiling[:40000, :9], batch_size=batch_size, verbose=2,
                        epochs=epoch,
                        callbacks=callback
                        )
    ...
    # # 自动调整布局
    # plt.tight_layout()
    # title = "./ar2000new" + experiment_time_end + ".png"
