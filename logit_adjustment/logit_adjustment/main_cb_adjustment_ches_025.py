from data_load_ches_10000 import read_data
...
def kl_cb_focal_factor_loss(y_true, y_pred):
    ...
    return K.sum(tf.multiply(y_true * K.log(y_true / y_pred), cb_factor), axis=-1)
...
if __name__ == '__main__':
    ...
    count = 0
    tro = 0.25
    log = open('F:/result/ches/cb_focal/025.txt', mode='a', encoding='utf-8')
    best_weights = None
    adjust_flag = True
